...
socialNetworks.set('www.facebook.com','facebook.svg');
socialNetworks.set('www.instagram.com','instagram.svg');
socialNetworks.set('twitter.com','twitter.svg');
...
const CONSTANTS = {
  ...
  MAX_FRIENDS: 5000,
  SOC_NETWORKS_MAP : socialNetworks,
};
